...
/**
 * An option for the Add-points Label dropdown, and an entry in the secret
 * objective gallery.
 *
 * @param group   heading it sits under in the dropdown, e.g. the phase a secret
 *                objective is scored in. May be null.
 * @param image   card scan filename resolved by naming convention, or null
