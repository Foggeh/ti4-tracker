...
import ti4.StandingsCalculator;
...
public class ApiController {
     ...
     *
     * <p>The arithmetic lives in {@link StandingsCalculator} so it can be tested
     * without a database or a running server; this method only fetches and
     * answers.
     */
    ...
    public Standings standings(@RequestParam("game") long gameId) {
        ...
        return StandingsCalculator.calculate(
                game, games.players(gameId), games.ledger(gameId), Instant.now());
    }
